export const pageMetadata = {
  collections: {
    title: 'Collections | Wardrobe 9 to 5 | Formal wear and smart casuals for Women',
...
export function generateProductMetadata(product) {
  return {
    title: `${product.name} | Wardrobe 9 to 5 | Formal wear and smart casuals for Women`,
...
export function generateCategoryMetadata(category) {
  return {
    title: `${category} | Wardrobe 9 to 5 | Formal wear and smart casuals for Women`,
